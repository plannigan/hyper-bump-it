...
from hyper_bump_it._hyper_bump_it.cli.interactive import top_level
...
def test_configure__git_edits__updated_git(force_input: ForceInput, mocker):
    ...
    mocker.patch(
        "hyper_bump_it._hyper_bump_it.cli.interactive.git.GitConfigEditor.configure",
...
def test_configure__files_edits__updated_config(
    ...
    mocker.patch(
        "hyper_bump_it._hyper_bump_it.cli.interactive.files.FilesConfigEditor.configure",
        return_value=(
            returned_files,
