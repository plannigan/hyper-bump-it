...
def test_by__valid__args_sent_to_config_for_bump_by(mocker):
    mock_config_for_bump_by = mocker.patch("hyper_bump_it._cli.by.config_for_bump_by")
...
def test_by__valid__app_config_passed_by_do_bump(mocker):
    ...
    mocker.patch("hyper_bump_it._cli.by.config_for_bump_by", return_value=app_config)
...
def test_by__hyper_bump_it_error__rich_message(mocker, capture_rich: StringIO):
    mocker.patch("hyper_bump_it._cli.by.config_for_bump_by")
    mocker.patch(
